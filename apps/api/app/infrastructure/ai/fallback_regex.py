"""Fallback: extração de partes e checklist padrão via regex (sem Groq)."""
...
def extract_parties_regex(form_text: str) -> dict:
    """Detecta partes usando palavras-chave no texto."""
...
def generate_checklist_default(parties: dict) -> dict:
    """Gera checklist padrão (pessoa física) para as partes detectadas."""
    checklist = []
